    ...
    return (
        <main className="add-friends-main">
            ...
            <section className="add-friend-content">
                ...
                <Link className="add-friend-list">
                    <article className="add-friend-card">
                        <div>
                ...
                <p>Ao adicionar amigos no Snakr, você pode acompanhar perfis, jogos, conquistas e atividades em comum.
                    ...
                    <br />
                    <br />
                    Os pedidos de amizade precisam ser aceitos para que a conexão seja estabelecida. Você pode gerenciar seus amigos e solicitações a qualquer momento nas configurações da sua conta.</p>
            </section>
        </main>
    )
}
